          ...
          <Reveal>
            <div className="glass border-glow relative flex h-full flex-col justify-between overflow-hidden rounded-3xl p-8 sm:p-10">
              ...
              <div className="relative z-10 flex h-56 items-center justify-center">
                ...
                <span className="relative h-3 w-3 rounded-full bg-primary shadow-[0_0_20px_6px_rgba(0,87,184,0.45)]" />
              </div>
    ...
    <label className="flex flex-col gap-2">
      ...
      {textarea ? (
        <textarea
          ...
          rows={4}
          required
          className="resize-none rounded-2xl border border-border bg-white/70 px-4 py-3 text-sm text-text outline-none transition-colors placeholder:text-text-secondary/60 focus:border-primary/50"
        />
      ) : (
        <input
          name={name}
          ...
          placeholder={placeholder}
          required
          className="rounded-2xl border border-border bg-white/70 px-4 py-3 text-sm text-text outline-none transition-colors placeholder:text-text-secondary/60 focus:border-primary/50"
        />
      )}
    </label>
  );
